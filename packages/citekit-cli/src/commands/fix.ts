...
export const fixCommand = addExamples(
  ...
  [
    'citekit fix --name "CiteOps" --domain citeopscloud.com --competitor "Profound"',
    'citekit fix --name "CiteOps" --domain citeopscloud.com --prompt "best ai visibility platform" --json',
  ],
  providerCommandNote(),
);
